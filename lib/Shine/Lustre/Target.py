...
class Target(Component, Disk):
    ...
    def __init__(self, fs, server, index, dev, jdev=None, group=None,
        ...
        # Begining with ticket #14, each Target holds a version attribute
        self.version = None
    ...
    def update(self, other):
        ...
        # other could be a pre-#14 object, in this case, let's report it.
...
#
    ...
    def __setstate__(self, state):
        ...
        if not hasattr(self, 'version'):
            # Remote object is a pre-#14 object.
