...
fs_name: param
nid_map: nodes=foo[1-12] nids=foo[1-12]@tcp
...
mount_path: /param
    ...
    def test_action_enabled_nodes(self):
        ...
        self.assertEqual(comps[0].server.action_enabled, True)
        self.assertEqual(comps[1].server.action_enabled, True)
        self.assertEqual(comps[2].server.action_enabled, False)
        self.assertEqual(comps[3].server.action_enabled, False)
        self.assertEqual(comps[4].server.action_enabled, True)
        self.assertEqual(comps[5].server.action_enabled, True)
    ...
    def test_action_enabled_exclude(self):
        ...
        self.assertEqual(comps[0].TYPE, Client.TYPE)
        self.assertEqual(comps[1].TYPE, Client.TYPE)
        self.assert_comp(comps[2], OST.TYPE, None, "/dev/sde")
        self.assert_comp(comps[3], OST.TYPE, None, "/dev/sdf")
        self.assert_comp(comps[4], OST.TYPE, None, "/dev/sde")
        self.assert_comp(comps[5], OST.TYPE, None, "/dev/sdf")
