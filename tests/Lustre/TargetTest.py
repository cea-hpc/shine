...
class GetStateTest(unittest.TestCase):
    ...
    def set_state(self, states):
        for node, state in states.iteritems():
            self.tgt.set_state(state, node=node)
    ...
    def test_master_and_none(self):
        ...
        self.set_state({self.srv1name: MOUNTED,
                        self.srv2name: None,
                        self.srv3name: None,
                        self.srv4name: None})
        self.assertEqual(self.tgt.state, MOUNTED)
        self.set_state({self.srv1name: RECOVERING,
                        self.srv2name: None,
                        self.srv3name: None,
                        self.srv4name: None})
        self.assertEqual(self.tgt.state, RECOVERING)
        self.set_state({self.srv1name: OFFLINE,
                        self.srv2name: None,
                        self.srv3name: None,
                        self.srv4name: None})
        self.assertEqual(self.tgt.state, OFFLINE)
        self.set_state({self.srv1name: TARGET_ERROR,
                        self.srv2name: None,
                        self.srv3name: None,
                        self.srv4name: None})
        self.assertEqual(self.tgt.state, TARGET_ERROR)
        self.set_state({self.srv1name: RUNTIME_ERROR,
                        self.srv2name: None,
                        self.srv3name: None,
                        self.srv4name: None})
    ...
    def test_failover_and_none(self):
        ...
        self.set_state({self.srv1name: None,
    ...
    def test_various_states(self):
        ...
        self.set_state({self.srv1name: OFFLINE,
                        self.srv2name: OFFLINE,
                        self.srv3name: OFFLINE,
                        self.srv4name: TARGET_ERROR})
        self.assertEqual(self.tgt.state, OFFLINE)
        self.set_state({self.srv1name: OFFLINE,
                        self.srv2name: OFFLINE,
                        self.srv3name: OFFLINE,
                        self.srv4name: RUNTIME_ERROR})
        self.assertEqual(self.tgt.state, OFFLINE)
        self.set_state({self.srv1name: MOUNTED,
                        self.srv2name: OFFLINE,
                        self.srv3name: OFFLINE,
